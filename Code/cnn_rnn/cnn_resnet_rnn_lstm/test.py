...
def main():
    ...
    logging.basicConfig(level=logging.INFO,
                        ...
                        handlers=[logging.FileHandler(os.path.join(args.out_dir, 'log_test.txt')),
    ...
    test_ds = CNNRNNDataset(args.data_root, 'test', args.num_frames, transform)
    test_loader = DataLoader(test_ds, batch_size=args.batch_size, shuffle=False)

    model = CNNRNN(len(test_ds.class_to_idx)).to(device)
