...
def main():
    ...
    parser.add_argument('--data_root', required=True, help="Root folder with train/val/test subfolders")
    parser.add_argument('--num_frames', type=int, default=16, help="Frames per clip (<=16)")
    parser.add_argument('--epochs', type=int, default=40)
    parser.add_argument('--batch_size', type=int, default=16)
    parser.add_argument('--lr', type=float, default=1e-3)
    parser.add_argument('--wd', type=float, default=5e-4)
    parser.add_argument('--patience', type=int, default=20, help="Early stopping on val-acc")
    parser.add_argument('--num_workers', type=int, default=0, help="DataLoader workers (0 for Windows)")
    parser.add_argument('--out_dir', default='output', help="Directory for logs, plots, model")
