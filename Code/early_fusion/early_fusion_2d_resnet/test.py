...
def main():
    ...
    test_ds = EarlyFusionDataset(args.data_root, 'test', args.num_frames, transform)
    test_loader = DataLoader(test_ds, batch_size=args.batch_size, shuffle=False)

    model = EarlyFusionResNet(len(test_ds.class_to_idx), args.num_frames).to(device)
